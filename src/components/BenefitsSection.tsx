      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {benefits.map((benefit, index) => (
            <div 
              key={index}
              className="card-premium p-8 group hover:scale-[1.02] transition-all duration-300"
            >
        ...
        <div className="mt-16 text-center">
          <div className="card-premium p-8 max-w-4xl mx-auto">
            <h3 className="text-3xl font-premium font-bold mb-6 text-gold-gradient">
              Бонус для участниц
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-2xl font-premium font-bold text-gold mb-2">90 дней</div>
                <p className="text-muted-foreground font-modern">Поддержка в чате после мероприятия</p>
              </div>
              <div>
                <div className="text-2xl font-premium font-bold text-gold mb-2">Эксклюзив</div>
                <p className="text-muted-foreground font-modern">Доступ к закрытому сообществу</p>
              </div>
              <div>
                <div className="text-2xl font-premium font-bold text-gold mb-2">Материалы</div>
                <p className="text-muted-foreground font-modern">Записи и презентации всех спикеров</p>
              </div>
            </div>
          </div>
        </div>
